...
import { CopyIcon, RefreshIcon, ShieldIcon, SparklesIcon, GlobeIcon, AlertCircleIcon } from "./icons"
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-border bg-card p-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h3 className="font-mono text-base font-medium">General Settings</h3>
            <p className="font-mono text-xs text-muted-foreground">Configure your URL shortener preferences</p>
          </div>
        </div>

        <div className="space-y-6">
          <div>
            <label className="font-mono text-sm font-medium">Custom Domain</label>
            <p className="mt-1 font-mono text-xs text-muted-foreground">Use your own domain for shortened links</p>
            <input
              type="text"
              value={customDomain}
            ...
            <p className="mt-2 font-mono text-xs text-muted-foreground">
              Add a CNAME record pointing to <code className="rounded bg-muted px-1 py-0.5">short.link</code>
            </p>
          </div>

          <div>
            <label className="font-mono text-sm font-medium">Default Link Expiration</label>
            <p className="mt-1 font-mono text-xs text-muted-foreground">Set default expiration time for new links</p>
            <select
          ...
          <div>
            ...
            <p className="mt-1 font-mono text-xs text-muted-foreground">Used for analytics and scheduling</p>
      ...
      <div className="rounded-lg border border-border bg-card p-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h3 className="font-mono text-base font-medium">Self-Healing Settings</h3>
            <p className="font-mono text-xs text-muted-foreground">Configure automatic link healing behavior</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <label className="font-mono text-sm font-medium">Enable Auto-Healing</label>
              <p className="mt-1 font-mono text-xs text-muted-foreground">
                Automatically fix broken links using semantic search and Wayback Machine
              </p>
            </div>
            <button
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <label className="font-mono text-sm font-medium">Healing Notifications</label>
              <p className="mt-1 font-mono text-xs text-muted-foreground">
          ...
          <div>
            <label className="font-mono text-sm font-medium">Healing Strategy</label>
            <p className="mt-1 font-mono text-xs text-muted-foreground">Choose how to handle broken links</p>
            <select className="mt-3 w-full rounded-md border border-input bg-background px-3 py-2 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-foreground/20">
          ...
          <div>
            <label className="font-mono text-sm font-medium">Check Frequency</label>
            <p className="mt-1 font-mono text-xs text-muted-foreground">How often to check link health</p>
            <select className="mt-3 w-full rounded-md border border-input bg-background px-3 py-2 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-foreground/20">
      ...
      <div className="rounded-lg border border-border bg-card p-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="font-mono text-xs text-muted-foreground">Configure AI-powered features</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <label className="font-mono text-sm font-medium">Auto-Generate Summaries</label>
              <p className="mt-1 font-mono text-xs text-muted-foreground">
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <label className="font-mono text-sm font-medium">Enable AI Chat</label>
              <p className="mt-1 font-mono text-xs text-muted-foreground">Ask questions about your links using AI</p>
            </div>
            <button
          ...
          <div>
            <label className="font-mono text-sm font-medium">Memory Retention</label>
            <p className="mt-1 font-mono text-xs text-muted-foreground">How long to keep AI conversation history</p>
            <select className="mt-3 w-full rounded-md border border-input bg-background px-3 py-2 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-foreground/20">
          ...
          <div>
            ...
            <p className="mt-1 font-mono text-xs text-muted-foreground">Choose the AI model for summaries and chat</p>
            <select className="mt-3 w-full rounded-md border border-input bg-background px-3 py-2 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-foreground/20">
      ...
      <div className="rounded-lg border border-border bg-card p-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="font-mono text-xs text-muted-foreground">Manage API access and webhooks</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-1 font-mono text-xs text-muted-foreground">Use this key to authenticate API requests</p>
            ...
            <p className="mt-2 font-mono text-xs text-muted-foreground">
              Keep your API key secret. Regenerating will invalidate the old key.
            </p>
          </div>
          ...
          <div>
            <label className="font-mono text-sm font-medium">Webhook Events</label>
            <p className="mt-1 font-mono text-xs text-muted-foreground">Choose which events trigger webhooks</p>
            <div className="mt-3 space-y-2">
              {["Link created", "Link clicked", "Link healed", "Link expired", "Link deleted"].map((event) => (
          ...
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-mono text-sm font-medium text-blue-900">API Documentation</h4>
      ...
      <div className="rounded-lg border border-red-200 bg-red-50 p-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h3 className="font-mono text-base font-medium text-red-900">Danger Zone</h3>
            <p className="font-mono text-xs text-red-700">Irreversible and destructive actions</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between rounded-lg border border-red-200 bg-white p-4">
            <div>
              <h4 className="font-mono text-sm font-medium text-red-900">Delete All Links</h4>
          ...
          <div className="flex items-center justify-between rounded-lg border border-red-200 bg-white p-4">
            <div>
              <h4 className="font-mono text-sm font-medium text-red-900">Delete Account</h4>
              <p className="mt-1 font-mono text-xs text-red-700">
