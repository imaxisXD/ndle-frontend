						...
						<div className="flex items-start justify-between">
							<div className="flex-1">
								<div className="flex items-center gap-3">
									...
									<span
										className={`rounded-full border px-2 py-0.5 font-mono text-xs ${getStatusBadge(link.status)}`}
									>
								...
								<div className="mt-4 grid gap-4 md:grid-cols-4">
									...
									<div>
										...
										<p
											className={`mt-1 font-mono text-sm font-medium ${getResponseTimeColor(link.responseTime)}`}
										>
