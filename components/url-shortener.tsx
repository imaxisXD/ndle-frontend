  ...
  return (
    <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
      <div className="space-y-4">
        <div>
          <label htmlFor="url" className="mb-2 block font-mono text-sm text-muted-foreground">
            Enter your long URL
          </label>
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="bg-foreground font-mono text-sm text-background hover:bg-foreground/90"
            >
              Shorten
            </Button>
          </div>
        ...
        {shortUrl && (
          <div className="rounded-xl border border-border bg-accent p-4">
            <div className="mb-2 font-mono text-xs text-muted-foreground">Your shortened URL</div>
            <div className="flex items-center justify-between">
              <code className="font-mono text-sm font-medium text-foreground">{shortUrl}</code>
              <div className="flex gap-2">
                <button
                  onClick={handleCopy}
