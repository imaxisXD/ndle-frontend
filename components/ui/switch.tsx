...
const switchVariants = cva(
  `
    relative peer inline-flex shrink-0 border border-black/10 cursor-pointer items-center rounded-full transition-colors 
    ...
    disabled:cursor-not-allowed disabled:opacity-50 data-[state=unchecked]:bg-gradient-to-b data-[state=unchecked]:from-neutral-100 data-[state=unchecked]:to-neutral-200
  ...
  `,
  {
    variants: {
      ...
      permanent: {
        true: "bg-input",
        false:
          "data-[state=checked]:bg-gradient-to-b data-[state=checked]:from-neutral-900 data-[state=checked]:to-neutral-950",
      },
    },
    defaultVariants: {
      shape: "pill",
...
const switchThumbVariants = cva(
  "pointer-events-none block w-1/2 h-[calc(100%-4px)] shadow-lg ring-0 transition-transform start-0 data-[state=unchecked]:translate-x-[2px] data-[state=checked]:translate-x-[calc(100%-2px)] rtl:data-[state=unchecked]:-translate-x-[2px] rtl:data-[state=checked]:-translate-x-[calc(100%-2px)] bg-gradient-to-b from-accent to-accent/80",
  {
    variants: {
      shape: {
        pill: "rounded-full",
