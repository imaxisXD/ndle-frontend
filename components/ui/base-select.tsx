...
function SelectClear({
  ...
  return (
    <button
      ...
      className={cn(
        `absolute end-2 top-1/2 -translate-y-1/2 cursor-pointer rounded-sm opacity-60 transition-opacity hover:opacity-100 focus:ring-0 focus:ring-offset-0 focus:outline-none disabled:pointer-events-none data-[disabled]:pointer-events-none`,
        className,
      )}
      onClick={handleClick}
      {...props}
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        "bg-popover fixed top-0 right-0 left-0 z-10 flex w-full cursor-default items-center justify-center rounded-t-md py-1",
        className,
      )}
      {...props}
    >
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      className={cn(
        "bg-popover fixed right-0 bottom-0 left-0 z-10 flex w-full cursor-default items-center justify-center rounded-b-md py-1",
        className,
      )}
      {...props}
    >
